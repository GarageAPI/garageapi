package net.garagecloud.basical.command.manager;

import com.google.common.collect.Lists;
import lombok.AccessLevel;
import lombok.Getter;
import lombok.NoArgsConstructor;
import net.garagecloud.basical.GarageAPI;
import net.garagecloud.basical.command.BaseCommand;
...
public final class CommandManager {
    ...
    public void registerCommand(BaseCommand<?> baseCommand,
        ...
        registerCommand(GarageAPI.getInstance(), baseCommand, command, aliases);
    }
